...
such as \textbf{TCP}. Its main goal is to provide \textbf{confidentiality} and \textbf{integrity}
between the two communicating peers. Confidentiality implies that a third party will not
...
exchange various messages. This message flow is depicted in Figure \ref{fig:tls-12-handshake} and described in more detail in Section
\ref{hsp}.
