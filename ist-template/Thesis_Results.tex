...
tools are described in Section \ref{sec:developed-tools}.
...
is $72.5\%$. Considering that the device will perform a Handshake for each new connection, it only makes sense to focus on Handhake cost optimization if the amount of exhanged data is small. This is the case of many
