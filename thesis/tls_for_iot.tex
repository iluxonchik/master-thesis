...
cost metrics that would be interesting to analyze. First, it's important to remember than an estimate of the number
of CPU cycles was used. It would be of interest to obtain the actual count of CPU cycles, by querying the
processor directly. Tools such as PAPI\cite{dongarra2001using} can be used for this purpose.
