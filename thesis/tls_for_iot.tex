...
This section as follows. Section 8.1 describes the various security levels used for evaluation. Section 8.2
...
confidentiality, integrity. Section 8.6 the cost of the Record protocol is analyzed. In that same section we also
...
\begin{table}[]
  ...
  \begin{tabular}[c]{@{}l@{}}Symmetric Key Size\\ (bits)\end{tabular}  & 128               & 128               & 192           & 256            \\ \hline
  \begin{tabular}[c]{@{}l@{}}RSA/DH/DSA Key Size\\ (bits)\end{tabular} & 1024              & 2048              & 4092          & 8192           \\ \hline
  \begin{tabular}[c]{@{}l@{}}ECC Key Size\\ (bits)\end{tabular}        & 163               & 233               & 317           & 420            \\ \hline
  HMAC                                                                 & SHA-256           & SHA-256           & SHA-384       & SHA-512        \\ \hline
  \end{tabular}
  \end{table}
...
We could not find any typical values used in the sphere of \gls{iot}.

A detailed description of the \textbf{normal} security level follows.
