...
\begin{itemize}
  \item \textbf{\gls{tls} Record Protocol} -
...
%\begin{figure}
%  \includegraphics[width=0.5\textwidth]{img/tls-sub-protocols.png}
%  \caption{TLS (Sub)protocols and Layers}
%  \label{fig:tls-subprotocols}
%\end{figure}
