...
centered around computer security and the topics that surround it. I've been a listener
since $2012$ and a I've noticed a clear trend: as the time goes on, the lack of
...
more and more often. In fact, now it's mentioned almost every week.
...
well as how I will be evaluating my results, how I'm planning to develop my work
and a conclusion.
...
which are function where it's easy to compute the answer given an input,
but hard to compute the input given the answer. For example, RSA uses factoring
as the one one way function: it's easy to multiply large numbers, but it's hard
to factor them.
...
\begin{figure}
    ...
    \begin{minipage}{0.5\textwidth}
        \centering
        \includegraphics[width=1.0\textwidth]{img/record-header-2.png} % first figure itself
        \caption{\label{fig:tls-record-header} TLS Record header}
    \end{minipage}\hfill
    \begin{minipage}{0.47\textwidth}
        \centering
        \includegraphics[width=1.0\textwidth]{img/tls-sub-protocols-2.png} % second figure itself
...
the \gls{tls} version chosen by the server and it's the one that is gonna be
