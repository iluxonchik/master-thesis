...
costs of those services, with an evaluation of various security levels. In section 8.4 we analyze the cost
...
Handshake with different ciphersuites. In this section, we will analyze this security service in detail, including the
underlying algorithms.

\subsubsection{PSK Authentication Cost Analysis}

In the prevoius seciton we approximated the cost of \gls{psk} authentication to be $1.119$ million CPU cycles
...
This value can be seen as the TLS overhead. The majority of those costs are spent in the \gls{prf}, when generating the
