...
This increase more modest for public key operations. This information is shown in Figure \ref{fig:rsa-pub-priv-cost-increase}. 
The percentages show the relative cost increase from the previous security level. An analysis Figure \ref{fig:rsa-pub-priv-cost-increase}
...
is about $x1.5$ larger than the verifying one. This has a cumulative effect: the constatly larger value increses even more. This
is shown graphically in Figure \ref{fig:rsa-ecdsa-pub-priv-ratio}, which for \gls{rsa}, presents the ratio between the cost of private and 
public key operations. As the security level increases, the value becomes larger. 
...
\begin{figure}
  ...
  \caption{\label{fig:rsa-costs-all-sls} Relative increase of RSA operation costs}
\end{figure}
