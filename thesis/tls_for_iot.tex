...
\begin{itemize}
  ...
  the layer that runs directly on top of \textbf{TCP/IP} and it serves as an
   ...
   The \gls{tls} Record header is comprised of 4 fields: a 1-byte \codeword{record type},
...
Every message sent in \gls{tls} comes with a \gls{tls} Record header. Each record
header has 4 fields:
