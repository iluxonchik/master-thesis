...
An analysis of the data shows a much higher relative increase in private key operations that in public ones.
...
increase in the cost of public key operations. The reason for that discrepancy has to do with an optimization
