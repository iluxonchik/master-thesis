...
\begin{table}[]
  ...
  \end{tabular}
  \centering \caption{\label{table:rsa-costs-all-sls} RSA and ECDSA signature creation and verification costs. Numbers in parenthesis is the standard deviation} \end{table}
...
\end{tabular}
\centering \caption{\label{table:pfs-cost-client} \gls{pfs} and \textit{ECDH} key exchange cost for the client}
\end{table}
...
\end{tabular}
\centering \caption{\label{table:pfs-cost-server} \gls{pfs} and \textit{ECDH} key exchange cost for the server}
\end{table}
...
\subsection{Time Measurments with PAPI and Their Comparison To The Estimated Values}
...
\subsubsection{PAPI Handhsake Time Cost Analysis} \label{sec:papi-handshake}
...
\subsubsection{Comparing Valgrind and PAPI Ratios} \label{sec:papi-valgrind-ratios}
...
\begin{figure}
  \centering
  \includegraphics[width=1.0\textwidth]{img/hs_papi_server.png}
  \centering \caption{\label{fig:server-hs-cost-all-sls-papi-o} Server handshake cost in microseconds for all security levels (logarithmic scale)}
\end{figure}
...
\begin{table}[]
  ...
  \textbf{ECDSA} & 548841 (45064) & 662348 (45175) & 666866 (45923)  & 704135 (48247)        \\ \hline
  \end{tabular}
  \centering \caption{ \label{table:cert-parse-cost-a} Additional costs of parsing the certificate}
