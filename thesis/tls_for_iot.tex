...
For the credential types the document considers 3 cases:
...
\begin{itemize}
  ...
  The profile recommends the use of shorter \gls{psk} identities. The only
  mandatory-to-implement ciphersuite to be used wit h\gps{psk}s is \codeword{TLS_PSK_WITH_AES_128_CCM_8},
  which is also mandated by \gls{coap}.
...
\gls{psk}\cite{rfc4279}, \gls{rpk}\cite{rfc7250}
and certificates. If \gls{psk}
