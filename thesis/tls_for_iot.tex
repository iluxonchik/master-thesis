...
reason, our work was concentrated around the Handshake protocol, even though we evaluated the costs of the
Record protocol too.
...
The RSA key exchange is performed as follows:

\begin{enumerate}
  \item Server sends the client 
  \item Server sends the client
\end{enumerate}
