...
Handshke Protocol and the second under the Record Protocol.
...
In reality, \gls{tls} is composed of several protocols (illustrated in Figure \ref{fig:tls-subprotocols}), which are briefly described below:
\begin{itemize}
...
\subsection{Cipher Spec vs Cipher Suite}
