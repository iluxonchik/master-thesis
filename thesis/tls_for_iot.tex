...
of UDP is mostly used in such devices. The work that will be done in the context of this dissertation, can however,
...
of persistent memory. I measured the resulting size of the complied \textit{mbedTLS 2.6.0} library
