...
\codeword{client_read_key}, \codeword{server_write_key}, \codeword{server_read_key}.

\todo{RESEARCH if the above is true for TLS 1.3. I think it actually uses the same key}
...
the \gls{prf} function to be used), the rest remains exactly the same.
