...
In the process of the work on this dissertation, I have made several
contributions to the \gls{tls} $1.3$ specification and recognized as a contributor\cite{Mergepul65:online}.
...
This means that in \gls{tls} $1.3$ you can have \codeword{0-RTT} data, by
