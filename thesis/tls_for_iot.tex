...
and use of secure communications from the application developer's standpoint. All the
devoper has to do is create a "secure" connection, instead of a "normal" one.
...
\subsection{SSL vs TLS: What's The Difference?}
